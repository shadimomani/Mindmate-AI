...
export const translations: Translations = {
  ...
  // Onboarding
  letsUnderstandYou: { en: "Let's understand you", ar: "دعنا نفهمك" },
  twoQuickQuestions: { en: "Two quick questions. We'll build your first plan from here.", ar: "سؤالان سريعان. سنبني خطتك الأولى من هنا." },
  biggestProblem: { en: "What is your biggest problem right now?", ar: "ما هي أكبر مشكلة تواجهك الآن؟" },
  biggestProblemPlaceholder: { en: "I can't focus on my work and keep procrastinating...", ar: "لا أستطيع التركيز على عملي وأستمر في التسويف..." },
  mainGoalQuestion: { en: "What is your main goal?", ar: "ما هو هدفك الرئيسي؟" },
  mainGoalPlaceholder: { en: "I want to study consistently and pass my exams...", ar: "أريد أن أدرس باستمرار وأنجح في امتحاناتي..." },
